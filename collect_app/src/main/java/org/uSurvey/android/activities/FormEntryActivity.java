...
import org.uSurvey.android.exception.JavaRosaException;
import org.uSurvey.android.listeners.AdvanceToNextListener;
import org.uSurvey.android.listeners.FormLoaderListener;
import org.uSurvey.android.listeners.FormSavedListener;
import org.uSurvey.android.listeners.SavePointListener;
import org.uSurvey.android.logic.FormController;
import org.uSurvey.android.logic.FormController.FailedConstraint;
import org.uSurvey.android.preferences.AdminPreferencesActivity;
...
import org.uSurvey.android.provider.InstanceProviderAPI.InstanceColumns;
import org.uSurvey.android.tasks.FormLoaderTask;
import org.uSurvey.android.tasks.SavePointTask;
import org.uSurvey.android.tasks.SaveResult;
import org.uSurvey.android.tasks.SaveToDiskTask;
import org.uSurvey.android.utilities.CompatibilityUtils;
import org.uSurvey.android.utilities.FileUtils;
import org.uSurvey.android.utilities.MediaUtils;
import org.uSurvey.android.views.ODKView;
...
public class FormEntryActivity extends Activity implements AnimationListener,
    ...
    private void createRepeatDialog() {
        ...
        if (formController.getLastRepeatCount() > 0) {
            String prompt = formController.getGroupPrompt();
            if (prompt != null) {
                mAlertDialog.setTitle(prompt);
...
//        }
    ...
    private void sendSavedBroadcast() {
        Intent i = new Intent();
        i.setAction("org.uSurvey.android.FormSaved");
