        ...
        try {
            ...
            if (statusCode != HttpStatus.SC_OK) {
                ...
                return new DocumentFetchResult(u.toString()
                        + " responded with: " + webError, statusCode).setReasonPhrase(response.getStatusLine().getReasonPhrase());
            }
            ...
            if (c.toString().equalsIgnoreCase("libcore.io.ErrnoException: isConnected failed: ECONNREFUSED (Connection refused)"))
                cause = "Unable to connect server";
            else
                cause = c.toString();
//			String error = "Error: " + cause + " while accessing "
//					+ u.toString();
            String error = "Error: " + cause;
