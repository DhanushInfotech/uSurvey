...
import org.uSurvey.android.listeners.AudioPlayListener;
import org.uSurvey.android.utilities.TextUtils;
import org.uSurvey.android.views.MediaLayout;
    ...
    public SelectOneWidget(Context context, FormEntryPrompt prompt) {
        ...
        if (mItems != null) {
            for (int i = 0; i < mItems.size(); i++) {
                ...
                if (prompt.isNonEditable() && prompt.isInstanceDownloaded())
                    r.setEnabled(false);
                buttons.add(r);
